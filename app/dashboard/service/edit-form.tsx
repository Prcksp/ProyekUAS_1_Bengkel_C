    ...
    <form action={dispatch}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <div id="id_customer-error" aria-live="polite" aria-atomic="true">
        ...
        <div className="mb-4">
          ...
          <div id="id_montir-error" aria-live="polite" aria-atomic="true">
        ...
        <div className="mb-4">
          ...
          <div id="id_sukucadang-error" aria-live="polite" aria-atomic="true">
