    ...
    <section className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row ">
      ...
      <div className="relative z-20 mt-8 flex flex-1 flex-col xl:w-1/2">
        ...
        <p className="reglar-16 mt-6 text-black xl:max-w-[520px]">
          Welcome to the Rejuvenation & Joyful Productivity (RJP) Workshop, a
          transformative experience designed to help you rediscover balance,
          enhance your well-being, and boost your productivity in a joyful and
          sustainable way. This workshop is perfect for professionals,
          creatives, and anyone looking to integrate more harmony and efficiency
