...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      ...
      >
        <p
          className={`${poppins.className} text-3xl text-white md:text-3xl md:leading-normal`}
        >
          Atma Barbershop
        </p>
      </Link>
      <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        ...
        <form>
          <Link href="http://localhost:3000/">
            <button className="button flex h-[48px] w-full grow items-center justify-center gap-2 rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-amber-100 hover:text-amber-600 md:flex-none md:justify-start md:p-2 md:px-3">
